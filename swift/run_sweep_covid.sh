...
echo "EMEWS proj roo $EMEWS_PROJECT_ROOT"
export EXPID=$1
...
EXECUTABLE_SOURCE=$EMEWS_PROJECT_ROOT/code/PhysiBoSSv2/COVID19
DEFAULT_XML_SOURCE=$EMEWS_PROJECT_ROOT/code/PhysiBoSSv2/config/*
...
# /gpfs/scratch/bsc08/bsc008602/vm_emews_pbc/code/PhysiBoSSv2/config/emews_settings.xml
CMD_LINE_ARGS="$* -exe=$EXECUTABLE_OUT -settings=$DEFAULT_XML_OUT/tester.xml -parameters=$PARAMS_FILE_OUT"
