...
cell_counts = {}
inf_cells = {}
# mcds = pcdl.MultiCellDS(output_path=".")
for index in range(0,10):
    # 
    filename ='output%08u.xml' % index
    print(filename)
    mcds = pcdl.TimeSeries(filename,output_path=".")
    print(li_cellcount = [mcds.get_cell_df().shape[0] for mcds in mcdsts.get_mcds_list()]  )
